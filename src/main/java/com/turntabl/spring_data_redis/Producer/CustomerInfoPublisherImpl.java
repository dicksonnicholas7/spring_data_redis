package com.turntabl.spring_data_redis.Producer;

import com.turntabl.spring_data_redis.Model.Customer;
...
public class CustomerInfoPublisherImpl implements CustomerInfoPublisher {
    ...
    public CustomerInfoPublisherImpl(RedisTemplate<String, Object> redisTemplate, ChannelTopic topic) {
